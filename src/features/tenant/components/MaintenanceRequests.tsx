...
const MaintananceRequests = () => {
  ...
  return (
    <div className="bg-slate-100 dark:bg-gray-950/50 shadow-lg rounded-lg">
      <div className="px-4 py-4 border-b border-gray-200 dark:border-primary-600/20 flex justify-between items-center">
        <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Maintenance Requests</h3>
        <NewRequestModal onRequestCreated={fetchRequests} />
      </div>

      <div className="p-4">
        <ul className="divide-y divide-gray-200 dark:divide-primary-600/10">
          {requests.map((request) => (
            <li key={request._id} className="py-3 flex items-center space-x-4">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-900 dark:text-gray-200">{request.description}</p>
