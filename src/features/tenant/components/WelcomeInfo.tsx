...
const initiatePayment = async () => {
  ...
  try {
    ...
    const response = await axios.post(
      // "https://nyumba-smart-server-1.onrender.com/api/payment/pay",
            "https://nyumba-smart-server-1.onrender.com/api/payment/pay",
    ...
    const pollInterval = setInterval(async () => {
      try {
        ...
        const statusRes = await axios.get(
          `https://nyumba-smart-server-1.onrender.com/api/payment/status/${paymentId}`, // Include payment ID in the URL
          {
            headers: getAuthHeaders(), // Include authorization headers
          }
        );
