              ...
              <div
                  ...
                  <div className='flex-1 space-y-3'>
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-5'>
                      <div className='space-y-3'>
                        <div className='flex items-center gap-3 p-3 rounded hover:bg-gray-950/50'>
                          <div className='p-2 rounded-full bg-primary-600/30 dark:bg-primary-600/30'>
                            <User className='h-4 w-4 text-primary-600 dark:text-primary-600' />
                          </div>
                          <div>
                        ...
                        <div className='flex items-center gap-3 p-3 rounded hover:bg-gray-950/50'>
                          <div className='p-2 rounded-full bg-primary-600/30 dark:bg-primary-600/30'>
                            <MapPin className='h-4 w-4 text-primary-600 dark:text-primary-600' />
                          </div>
                          <div>
                      ...
                      <div className='space-y-3'>
                        <div className='flex items-center gap-3 p-3 rounded hover:bg-gray-950/50'>
                          <div className='p-2 rounded-full bg-primary-600/30 dark:bg-primary-600/30'>
                            <Calendar className='h-4 w-4 text-primary-600 dark:text-primary-600' />
                          </div>
                          <div>
                ...
                <div className='mt-4 pt-4 border-t border-primary-600/10'>
                  <div className='flex items-start gap-3'>
                    <div className='p-2 rounded-full bg-primary-600/30 dark:bg-primary-600/30 mt-0.5'>
                      <AlertCircle className='h-4 w-4 text-primary-600 dark:text-primary-600' />
                    </div>
                    <div>
