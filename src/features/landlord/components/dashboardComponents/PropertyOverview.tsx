    ...
    <div className="p-4 space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
        <div className="space-y-1 min-w-0 flex-1">
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight">Property Overview</h1>
          <p className="text-muted-foreground text-sm">Key metrics and statistics about your properties</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="hover-scale dark:bg-gray-950/50 shadow-md">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium truncate">Total Properties</CardTitle>
        ...
        <Card className="hover-scale dark:bg-gray-950/50 shadow-md">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium truncate">Occupied Units</CardTitle>
        ...
        <Card className="hover-scale dark:bg-gray-950/50 shadow-md">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium truncate">Vacant Units</CardTitle>
        ...
        <Card className="hover-scale dark:bg-gray-950/50 shadow-md">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium truncate">Maintenance</CardTitle>
            ...
            <div className="flex items-center justify-center h-32">
              <div className="relative w-24 h-24">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-2xl font-bold">{propertyStats.occupancyRate}%</span>
                </div>
              </div>
            </div>
