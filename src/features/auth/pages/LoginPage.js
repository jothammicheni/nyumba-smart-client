...
const LoginPage = () => {
    ...
    return (_jsx("div", { className: "min-h-screen flex items-center justify-center py-12 px-4 shadow-xl sm:px-6 lg:px-8 bg-gradient-to-br from-white via-white to-blue-50 dark:from-gray-950/60 dark:via-gray-950/70 dark:to-gray-950/60", children: _jsxs("div", { className: "max-w-md w-full space-y-8", children: [_jsxs("div", { className: "text-center", children: [_jsx("h2", { className: "mt-6 text-3xl font-extrabold text-gray-900 capitalize dark:text-white", children: "Sign in to your account" }), _jsxs("p", { className: "mt-2 text-sm text-gray-600 dark:text-gray-400", children: ["Or", " ", _jsx("a", { href: "/register", className: "font-medium text-primary-600 hover:text-primary-500", children: "create a new account" })] })] }), _jsxs("div", { className: "bg-white dark:bg-gray-900 shadow-xl rounded-lg p-8", children: [errors.general && (_jsxs("div", { className: "mb-4 p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-md flex items-start", children: [_jsx(AlertCircle, { className: "h-5 w-5 text-red-500 mr-2 flex-shrink-0 mt-0.5" }), _jsx("p", { className: "text-sm text-red-600 dark:text-red-400", children: errors.general })] })), _jsxs("form", { className: "space-y-6", onSubmit: handleSubmit, children: [_jsxs("div", { children: [_jsx("label", { htmlFor: "email", className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1", children: "Email address" }), _jsx("input", { id: "email", name: "email", type: "email", autoComplete: "email", value: formData.email, onChange: handleChange, className: `
