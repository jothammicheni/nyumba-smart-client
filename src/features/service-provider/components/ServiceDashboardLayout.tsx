...
export const ServicetDashboardLayout: React.FC = () => {
                    ...
                    <div className="flex-1 overflow-y-auto">
                        <nav className="px-2 py-4 space-y-1">
                            ...
                            <Link
                                to='earnings'
                                onClick={handleNavClick}
                                className={`flex items-center px-3 py-2 text-sm font-medium rounded-md ${isActive("/service-provider/dashboard/earnings")}`}>
                            ...
                            <Link
                                to="settings"
                                onClick={handleNavClick}
                                className={`flex items-center px-3 py-2 text-sm font-medium rounded-md ${isActive("/service-provider/dashboard/settings")}`}>
