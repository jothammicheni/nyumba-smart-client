              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  <DropdownMenuItem asChild>
                    <Link to={`/service-provider/dashboard/manage/gigs/view/${gig._id}`}>
                      <Eye className="h-4 w-4 mr-2" />
                      View Gig
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild>
                    <Link to={`/service-provider/dashboard/manage/gigs/edit/${gig._id}`}>
                      <Edit className="h-4 w-4 mr-2" />
                      Edit
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild>
                    <Link to={`/service-provider/dashboard/manage/gigs/analytics/${gig._id}`}>
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-8">
              ...
              <nav className="hidden md:flex items-center gap-6">
                ...
                <Link
                  to="/service-provider/dashboard/tasks"
                  className="text-gray-700 hover:text-primary-600"
                >
                  Orders
                </Link>
