    ...
    return (_jsxs("div", { className: "bg-white dark:bg-gray-900 rounded-lg shadow overflow-hidden", children: [_jsxs("div", { className: "p-6 border-b border-gray-200 dark:border-primary-600/20", children: [_jsx("h2", { className: "text-2xl font-bold text-gray-800 dark:text-white", children: "Account Settings" }), _jsx("p", { className: "text-gray-600 dark:text-gray-300 mt-1", children: "Manage your provider account preferences" })] }), _jsxs("div", { className: "flex flex-col md:flex-row", children: [_jsx("div", { className: "w-full md:w-64 border-b md:border-b-0 md:border-r border-gray-200 dark:border-primary-600/20", children: _jsxs("nav", { className: "space-y-5 p-4", children: [_jsxs("button", { onClick: () => setActiveTab('profile'), className: `flex items-center px-4 py-3 text-sm font-medium rounded-md w-full text-left 
              ...
              ${activeTab === 'security' ? 'bg-primary-50 dark:bg-gray-950/40 text-primary-600 dark:text-primary-600'
                ...
                ${activeTab === 'billing' ? 'bg-primary-50 dark:bg-gray-950/40 text-primary-600 dark:text-primary-600'
                                        : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-primary-600/20'}`, children: [_jsx(CreditCard, { className: "h-5 w-5 mr-3" }), "Billing & Payments"] })] }) }), _jsxs("div", { className: "flex-1 p-6", children: [activeTab === 'profile' && (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { children: [_jsx("h3", { className: "text-lg font-medium text-gray-800 dark:text-white", children: "Profile Information" }), _jsx("p", { className: "text-sm text-gray-500 dark:text-gray-400 mt-1", children: "Update your personal details" })] }), _jsxs("div", { className: "flex flex-col sm:flex-row gap-6", children: [_jsxs("div", { className: "flex-shrink-0", children: [_jsx("img", { className: "h-24 w-24 rounded-full object-cover", src: providerData.profileImage, alt: "Profile" }), _jsx("button", { className: "mt-3 w-full text-sm p-2 rounded font-medium text-primary-600 dark:text-primary-600 hover:text-primary-600 dark:hover:bg-primary-600/10", children: "Change photo" })] }), _jsxs("div", { className: "flex-1 space-y-5", children: [_jsxs("div", { className: "grid grid-cols-1 gap-4 sm:grid-cols-2", children: [_jsxs("div", { children: [_jsx("label", { htmlFor: "name", className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1", children: "Full Name" }), _jsx("input", { type: "text", id: "name", value: providerInfo.provider.name, onChange: (e) => setProviderInfo({
                                                                            ...providerInfo,
                                                                            provider: {
                                                                                ...providerInfo.provider,
                                                                                name: e.target.value
                                                                            }
                                                                        }), className: "block w-full rounded-md border border-gray-300 dark:border-gray-900/10 shadow-sm focus:border-primary-500 focus:ring-primary-600 sm:text-sm bg-white dark:bg-gray-950/50 p-2" })] }), _jsxs("div", { children: [_jsx("label", { htmlFor: "email", className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1", children: "Email" }), _jsx("input", { type: "email", id: "email", value: providerInfo.provider.email, onChange: (e) => setProviderInfo({
                                                                            ...providerInfo,
                                                                            provider: {
                                                                                ...providerInfo.provider,
                                                                                email: e.target.value
                                                                            }
                                                                        }), className: "block w-full rounded-md border border-gray-300 dark:border-gray-900/10 shadow-sm focus:border-primary-500 focus:ring-primary-600 sm:text-sm bg-white dark:bg-gray-950/50 p-2" })] })] }), _jsxs("div", { className: "grid grid-cols-1 gap-4 sm:grid-cols-2", children: [_jsxs("div", { children: [_jsx("label", { htmlFor: "phone", className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1", children: "Phone Number" }), _jsx("input", { type: "tel", id: "phone", value: providerInfo.provider.phone, onChange: (e) => setProviderInfo({
                                                                            ...providerInfo,
                                                                            provider: {
                                                                                ...providerInfo.provider,
                                                                                phone: e.target.value
                                                                            }
                                                                        }), className: "block w-full rounded-md border border-gray-300 dark:border-gray-900/10 shadow-sm focus:border-primary-500 focus:ring-primary-600 sm:text-sm bg-white dark:bg-gray-950/50 p-2" })] }), _jsxs("div", { children: [_jsx("label", { htmlFor: "phone", className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1", children: "City" }), _jsx("input", { type: "text", id: "city", value: providerInfo.provider.city, onChange: (e) => setProviderInfo({
                                                                            ...providerInfo,
                                                                            provider: {
                                                                                ...providerInfo.provider,
                                                                                city: e.target.value
