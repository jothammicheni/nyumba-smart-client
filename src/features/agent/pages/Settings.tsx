  ...
  useEffect(() => {
    const fetchAgentInfo = async () => {
      try {
        ...
        const response = await axios.get("https://nyumba-smart-server-1.onrender.com/api/agents/info", {
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                      ...
                      <input
                        type="text"
                        id="name"
                        value={agentInfo.agentProfile.name}
                        onChange={(e) => setAgentInfo({
                          ...agentInfo,
                          agentProfile: {
                    ...
                    <div>
                      ...
                      <input
                        type="email"
                        id="email"
                        value={agentInfo.agentProfile.email}
                        onChange={(e) => setAgentInfo({
                          ...agentInfo,
                          agentProfile: {
                            ...agentInfo.agentProfile,
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                      ...
                      <input
                        type="tel"
                        id="phone"
                        value={agentInfo.agentProfile.phone}
                        onChange={(e) => setAgentInfo({
                          ...agentInfo,
                          agentProfile: {
                            ...agentInfo.agentProfile,
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        id="city"
                        value={agentInfo.agentProfile.city}
                        onChange={(e) => setAgentInfo({
                          ...agentInfo,
                          agentProfile: {
                            ...agentInfo.agentProfile,
