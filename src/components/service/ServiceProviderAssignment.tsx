                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-2">
                            <h4 className="font-medium truncate">{provider.userId.name}</h4>
                            {provider.userId.isVerified && (<CheckCircle className="h-4 w-4 text-green-500 flex-shrink-0" />)}
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 space-y-1 text-sm text-muted-foreground mb-2">
                            ...
                            {provider.userId.phone && (
                              <div className="flex items-center gap-1">
                                ...
                                <span className="truncate">{provider.userId.phone}</span>
                              </div>
                            )}
                          </div>
              ...
              {selectedProvider && (
                <div className="bg-primary/5 border border-primary/20 rounded-lg p-3">
                  ...
                  <div className="space-y-1 text-xs">
                    <div className="flex items-center gap-1">
                      <span className="font-medium">{selectedProvider.userId.name}</span>
