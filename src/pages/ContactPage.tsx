    ...
    <div className="pt-16 pb-12 bg-gradient-to-br from-slate-100 via-white to-blue-50 dark:from-gray-950/60 dark:via-gray-950/70 dark:to-gray-950/60">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 lg:grid-cols-2">
            ...
            <div className="bg-white dark:bg-gray-900/70 rounded-lg shadow-md p-6 border border-gray-200 dark:border-gray-800 hover:scale-105 duration-300">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="mt-1 text-gray-600 dark:text-gray-300">info@TenaHub.com</p>
                </div>
              </div>
            </div>
          ...
          {/* Contact Form */}
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Share Your Message</h2>

            <div className="bg-white dark:bg-gray-900/70 border border-gray-200 dark:border-gray-800 shadow-xl rounded-lg overflow-hidden">
