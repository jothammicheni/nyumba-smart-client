...
const PropertiesPage = () => {
    ...
    return (_jsxs("div", { className: "min-h-screen bg-gray-50 dark:bg-gray-950/60 pt-20 pb-12", children: [_jsx(PropertyListingSEO, {}), _jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [_jsxs("div", { className: "text-center mb-12", children: [_jsx("h1", { className: "text-4xl font-bold text-primary-600 dark:text-primary-600 sm:text-5xl", children: "Find Your Perfect Home" }), _jsx("p", { className: "mt-2 max-w-2xl mx-auto text-xl font-semibold text-gray-600 dark:text-gray-300", children: "Discover properties that match your lifestyle and budget" })] }), _jsx(SearchFilters, { searchTerm: searchTerm, filters: filters, showFilters: showFilters, onSearchChange: handleSearchChange, onFilterChange: handleFilterChange, onToggleFilters: toggleFilters, onClearFilters: clearFilters }), _jsxs("div", { className: "mb-6 flex justify-between items-center", children: [_jsxs("h2", { className: "text-xl font-semibold text-gray-900 dark:text-white", children: [filteredProperties.length, " ", filteredProperties.length === 1 ? "Property" : "Properties", " Found"] }), _jsxs("div", { className: "text-sm text-gray-500 dark:text-gray-400", children: ["Page ", currentPage, " of ", totalPages] })] }), _jsx("div", { className: "grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3", children: currentProperties.length > 0 ? (currentProperties.map((property) => (_jsx(PropertyCard, { property: property, isFavorite: favorites.includes(property._id), onToggleFavorite: toggleFavorite, onViewDetails: openPropertyModal, formatCurrency: formatCurrency }, property._id)))) : (_jsxs("div", { className: "col-span-full text-center py-16", children: [_jsx(Home, { className: "mx-auto h-16 w-16 text-gray-400" }), _jsx("h3", { className: "mt-4 text-xl font-medium text-gray-900 dark:text-white", children: "No properties match your search" }), _jsx("p", { className: "mt-2 text-gray-500 dark:text-gray-400", children: "Try adjusting your filters or search for something different" }), _jsx("button", { onClick: clearFilters, className: "mt-4 px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white font-medium rounded-lg transition-colors", children: "Clear All Filters" })] })) }), _jsx(Pagination, { currentPage: currentPage, totalPages: totalPages, onPageChange: handlePageChange })] })] }));
};
