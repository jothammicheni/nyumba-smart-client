...
export const listingService = {
    ...
    async sendInquiryMessage(data) {
        try {
            const response = await axios.post(`http://localhost:5000/api/inquiry/sendinquiry`, data, {
                headers: {
...
export const trackImpression = async (listingId) => {
    try {
        const response = await axios.patch(`${API_BASE_URL}/api/listings/${listingId}/track-impression`, {}, // 👈 send an empty object instead of null
        {
            headers: {
                'Content-Type': 'application/json',
            },
...
export const trackClick = async (listingId) => {
    try {
        const response = await axios.patch(`${API_BASE_URL}/api/listings/${listingId}/track-click`, {}, // 👈 send an empty object instead of null
        {
            headers: {
                'Content-Type': 'application/json',
            },
...
export const getListingAnalytics = async (listingId) => {
    try {
